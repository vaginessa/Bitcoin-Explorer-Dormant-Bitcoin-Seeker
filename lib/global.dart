...
//Backgrounds
const backgroundColor = Color.fromRGBO(12, 12, 12, 1);
...
const focusIconColor = Color.fromARGB(255, 248, 150, 93);

//Margins / Paddings
const lateralContentMargins = EdgeInsets.only(left: 25, right:25);
const dialogContentMargins = EdgeInsets.all(25);
