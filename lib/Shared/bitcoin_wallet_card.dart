        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(widget.wallet.balance > 1 ? widget.wallet.balance.toStringAsFixed(2) : widget.wallet.balance.toString() + " BTC", style: const TextStyle(color:balanceColor, fontSize: 20, fontWeight: FontWeight.bold),),
            ],
          ),
        ),
      ),
