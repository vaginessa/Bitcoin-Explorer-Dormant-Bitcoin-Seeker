    ...
    return GestureDetector(
            ...
            children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      if (widget.wallet.seed == null &&
                          widget.wallet.privateKey == null)
                        Text(
                          widget.wallet.address,
                          overflow: TextOverflow.ellipsis,
                          style: const TextStyle(
                              color: unfocusIconColor, fontSize: 17.5),
                        )
                      else if (widget.wallet.seed != null ||
                          widget.wallet.privateKey != null) ...[
                        Text(
                          widget.wallet.seed != null
                              ? widget.wallet.seed!
                        ...
                        Text(widget.wallet.address,
                            overflow: TextOverflow.ellipsis,
                            style: const TextStyle(
                                color: unfocusIconColor, fontSize: 12.5))
                      ]
                    ],
                  ),
                ),
              ...
              Text(
                widget.wallet.balance > 1
                    ...
                    : widget.wallet.balance.toString() + " BTC",
                style: const TextStyle(
                    color: balanceColor,
                    fontSize: 20,
      ...
      onTap: () {
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    BitcoinWalletDetail(wallet: widget.wallet)));
      },
    );
  }
}
